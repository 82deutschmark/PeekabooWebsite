...
// This component renders the full Privacy Policy page for Peekaboo Interactive Games.
// It displays the entire contents of docs/privacy.md, the source of truth for privacy information.
// The policy is rendered using a markdown renderer to ensure formatting is preserved.
// Author: Cascade (OpenAI model)
// Last updated: June 3, 2025
//
// Usage:
// This page is used by the website to show the full privacy policy to users, ensuring compliance with legal and transparency requirements. Any changes to the privacy policy must be made in docs/privacy.md and then reflected here in full, with no omissions or truncation.
//
// Project usage: This file is imported as a route/page component in the web app. Do not edit the policy text here directly; always sync with docs/privacy.md.

import React from 'react';
import ReactMarkdown from 'react-markdown';

// The full privacy policy content below is copied verbatim from docs/privacy.md as of June 3, 2025.
const privacyPolicyMarkdown = `Privacy Policy for Big Happy Holding Company and Subsidiaries (Peekaboo Interactive Games)
